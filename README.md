...
>
> Horizon is a banking app that allows customers to link multiple bank accounts in a single app. Users are also able to make transfers between banks. It was built with Next.js, Shadcn, Tawilwind CSS, Dwolla
